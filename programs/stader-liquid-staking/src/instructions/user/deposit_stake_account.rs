...
use crate::{error::StaderLiquidStakingError, require_lte, state::stake_system::StakeSystem, State, ID};
...
impl<'info> DepositStakeAccount<'info> {
    ...
    pub fn process(&mut self, validator_index: u32) -> Result<()> {
        ...
        require_gte!(
            ...
            StaderLiquidStakingError::DepositingNotActivatedStake
        );
        ...
        require_gte!(
            ...
            StaderLiquidStakingError::TooLowDelegationInDepositingStake
        );
        ...
        require_eq!(
            ...
            StaderLiquidStakingError::WrongStakeBalance,
        );
        ...
        if lockup.is_in_force(&self.clock, None) {
            ...
            return err!(StaderLiquidStakingError::StakeAccountWithLockup)
...

        {
            ...
            // Can not deposit stake already under stader-stake auth. old staker must be different than ours
            require_keys_neq!(
                old_staker,
                new_staker,
                StaderLiquidStakingError::RedepositingStaderStake
            );
        ...
        let old_withdrawer = self.stake_account.meta().unwrap().authorized.withdrawer;
        {
            ...
            .unwrap();
            // Can not deposit stake already under stader-stake auth. old_withdrawer must be different than ours
            require_keys_neq!(
                old_withdrawer,
                new_withdrawer,
                StaderLiquidStakingError::RedepositingStaderStake
        ...
        let stader_sol_to_mint = self.state.calc_stader_sol_from_lamports(delegation.stake)?;
        ...
        self.state.on_stader_sol_mint(stader_sol_to_mint);
        ...
        emit!(DepositStakeAccountEvent {
            ...
            stader_sol_minted: stader_sol_to_mint,
