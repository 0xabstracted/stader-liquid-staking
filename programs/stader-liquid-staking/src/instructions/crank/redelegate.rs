...
impl<'info> ReDelegate<'info> {
    ...
    pub fn process(
        ...
        require_neq!(
            ...
            StaderLiquidStakingError::SourceAndDestValidatorsAreTheSame
        );
        ...
        // only allow redelegation in the stake/unstake window at the end of the epoch
        {
            ...
            //     StaderLiquidStakingError::TooEarlyForStakeDelta
            // );
        }
        ...
        // add new warming-up re-delegated account to Stader stake-accounts list
    ...
    pub fn split_stake_for_redelegation(
        ...
        // add the split account as new account to Stader stake-accounts list
        self.state.stake_system.add(
            &mut self.stake_list.to_account_info().data.as_ref().borrow_mut(),
            &self.split_stake_account.key(),
