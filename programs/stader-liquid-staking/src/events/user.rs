...
pub struct WithdrawStakeAccountEvent {
    ...
    pub validator_index: u32,
    pub user_stader_sol_balance: u64,
    pub user_stader_sol_auth: Pubkey, // owner of the staderSOL
    pub stader_sol_burned: u64,
    pub stader_sol_fees: u64,
