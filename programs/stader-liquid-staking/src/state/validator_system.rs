...
use crate::{calc::proportional, error::StaderLiquidStakingError, ID};
    ...
    pub fn new(
        ...
        require_keys_eq!(
            ...
            *duplication_flag_address,
            StaderLiquidStakingError::WrongValidatorDuplicationFlag
        );
...
impl AccountDeserialize for ValidatorList {
    ...
    fn try_deserialize(buf: &mut &[u8]) -> Result<Self> {
        if buf.len() < 8 {
            return err!(StaderLiquidStakingError::InvalidValidatorListDiscriminator);
        }
...
impl ValidatorSystem {
    ...
    pub fn remove(
        ...
        require_eq!(
            ...
            0,
            StaderLiquidStakingError::RemovingValidatorWithBalance
        );
