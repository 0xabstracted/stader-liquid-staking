...
import { staderSolMint, stakeList, validatorsList, stateAccount } from "../../../config";
...
export const depositNewStakeAccount = async (
    ...
    const [authorityStaderSolAcc] = PublicKey.findProgramAddressSync([stateAccount.toBuffer(), Buffer.from("st_mint")], contractAddr)
