...
import { InitializeDataParam, StaderSolInitParam } from "../../../types";
import { 
...
const simulate = async () => {
    let intParam : StaderSolInitParam = await preRequisiteSetup(connection, admin)
